...
void loop() {
 ...
 int value1 = pitch;
 int value2 = roll;
 if ((value1 > 500 && value1 < 540) && (value2 > 500 && value2 < 540)) {
  Serial.println("Estatico");
 } else if ((value1 < 500) && (value2 > 500 && value2 < 540)) {
  Serial.println("Frente");
 } else if ((value1 > 500 && value1 < 540) && (value2 > 540)) {
  Serial.println("Izquierda");
 } else if ((value1 > 500 && value1 < 540) && (value2 < 500)) {
  Serial.println("Derecha");
 } else {
  Serial.println("No tiemble");
 }
