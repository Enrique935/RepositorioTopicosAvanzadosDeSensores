...
//Serial.write(c);
    ...
    if (c == '\n') {
      ...
      if (currentLine.startsWith("$GPGGA")) {
        ...
        Serial.println(currentLine);  //Para la recopilación de datos esta línea debe estar comentada
        Serial.print("Latitud:");     //Para la recopilación de datos esta línea debe estar comentada
        Serial.println(latitudeStr);
        Serial.print("Longitud:");    //Para la recopilación de datos esta línea debe estar comentada
